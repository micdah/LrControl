namespace LrControl.LrPlugin.Api.Modules.LrDevelopController.Parameters
{
    public class LensCorrectionsPanelParameter : ParameterGroup
    {
        ...
        public static readonly IParameter<double> PerspectiveRotate                = new Parameter<double>("PerspectiveRotate", "Transform: Rotate");
        ...
        public static readonly IEnumerationParameter<int> PerspectiveUpright       = EnumerationParameter<int>.Create<UprightValue>("PerspectiveUpright", "Upright");

        internal LensCorrectionsPanelParameter() : base("Lens Corrections",
            LensProfileDistortionScale, LensProfileVignettingScale, LensProfileChromaticAberrationScale,
