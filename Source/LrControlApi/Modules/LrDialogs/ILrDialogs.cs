...
namespace LrControl.Api.Modules.LrDialogs
{
    ...
    public interface ILrDialogs
    {
        ...
        [LuaMethod]
        bool Confirm(out ConfirmResult confirmResult, string message, string info, string actionVerb, string cancelVerb, string otherVerb = null);
        ...
        /// </param>
        [LuaMethod]
        bool Message(string message, string info = null, DialogStyle style = null);
        ...
        [LuaMethod]
        bool ShowBezel(string message, double? fadeDelay = null);
        ...
        /// </param>
        [LuaMethod]
        bool ShowError(string errorString);
    }
}